...
define(['../module'], function(ng) {
            ...
            tools = $.extend(tools, {
                ...
                uploadFile: function(file) {
                    ...
                    for (var i = 0, len = myFiles.length; i < len; i++) {
                        ...
                        if ((!/.*\.(jpg)|(jpeg)|(gif)|(png)|(doc)|(docx)|(xls)|(xlsx)|(ppt)|(pdf)|(JPG)|(JPEG)|(GIF)|(PNG)|(DOC)|(DOCX)|(XLS)|(XLSX)|(PPT)|(PDF)|(avi)|(mp4)|(rmvb)|(rm)$/.test(fileItem.name)) || fileItem.size > 2 * 1024 * 1024) {
                            $rootScope.alertMsgService.setMessage("请重新选择格式：jpg/jpeg/gif/png/doc/docx/xls/xlsx/ppt/pdf/avi/mp4/rmvb/rm;文件大小不超过2M", 'warning');
                            return false;
                        }
                    }
    ...
    ng.filter("checkIconBuyer", function() {
