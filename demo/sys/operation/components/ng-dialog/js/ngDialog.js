...
(function (root, factory) {
    ...
    m.provider('ngDialog', function () {
        var defaults = this.defaults = {
            ...
            width:410,
            title:'提示',
            confirmInfo:false   // eg. 你确认删除所选数据? 用在openConfirm里,示例在 purchaseReq.js
        };
            ...
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector) {
                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        // -[[add by chenxilan,2016-6-4 for the default confirm dialog with extra-param confirmInfo
                        if(options.confirmInfo && options.confirmInfo.length>0){
                            options.plain = true;
                            options.template = '<div class="activeDlg">'
                                        +'<div class="dlg-title">提示</div>'
                                        +'<div class="dlg-content form">'
                                            +'<p class="ta-c"><i class="iconfont icon-xunwenoms"></i> '+ options.confirmInfo +'</p>'
                                            +'<div class="btn-toolbar clearfix">'
                                                +'<button class="btn btn-cfec-red" ng-click="confirm();">确定</button>'
                                                +'<button class="btn btn-cfec-white" ng-click="closeThisDialog()">取消</button>'
                                            +'</div>'
                                        +'</div>'
                                        +'</div>';
                        }
                        ...
                        $q.all({
                            ...
                            var widthHtml = '';
                            if(options.width) {
                                widthHtml = 'style="width:'+options.width+'px";';
                            }

                            $dialog.html((options.overlay ?
                                '<div class="ngdialog-overlay"></div><div class="ngdialog-content" role="document" '+widthHtml+'>' + template + '</div>' :
                                '<div class="ngdialog-content" role="document" style="width:'+widthHtml+'>' + template + '</div>'));
                            ...
                            // add option by ken, 2016-06-01, Happy Children's Day!
                            
                            // title
                            if(options.title) {
                                $dialog.find('.dlg-title').html(options.title);
                            }
