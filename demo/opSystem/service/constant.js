define(['app'], function(app) {
    ...
    app.constant('api', {
        ...
        //免审时段更新设置
        freeExamine: url + '/oms/quotePrice/updateFreeAuditQuoteSetting.cf ',
        //批量设置免审
        batchTrial: url + '/oms/seller/setFreeAuditQuoteBatch.cf',
        //获取免审时段规则
        reviewRule: url + '/oms/quotePrice/queryFreeAuditQuoteSetting.cf ',
        /* 
           采购需求管理接口 ]]
        */
        ...
        */
        ...
        // 商品标签列表
        'getProductTagList': url + '/oms/product/tag.cf',
        // 新增/修改 商品标签
        'saveOrUpdateTagInfo': url + '/oms/product/tag/saveOrUpdateTag.cf',
        // 根据标签获取商品
        'getProductListByTag': url + '/oms/product/tag/getProductListByTag.cf',
        // 标签详情
        'getTagInfo': url + '/oms/product/tag/getTagInfo.cf',
        // 删除标签
        'delProductTag': url + '/oms/product/tag/delProductTag.cf',
        // 商品移除
        'removeTagProduct': url + '/oms/product/tag/pullOutProduct.cf',
        ...
        // 1049 检测遗漏待审核数据
        'auditIndex': url + '/oms/seller/auditIndex.cf',
        // 获取卖家详情
        ...
        // 店铺审核
        'sellerShopAudit': url + '/oms/sellerShop/audit.cf',
        // 会员套餐
        ...
        */
        ...
        // 导入
        importExhibiton: url + '/oms/promotionPlan/loadTemplate.cf',
        ...
        */
        ...
        saveAppIndex_v1: url + '/oms/app/saveHomepage0.cf',
        ...
        topicsList: url + '/oms/app/getHomepagePages.cf',
        saveTopic: url + '/oms/app/saveHomepagePage.cf',
        editTopic: url + '/oms/app/getHomepagePage.cf',
        updateTopic: url + '/oms/app/updateHomepagePage.cf',
        getHomepageCategories: url + '/oms/app/getHomepageCategories.cf',
        ...
        // 导出用户标签
        reportUserTag: url + '/oms/pushMessage/exportTagList.cf',

        // 获取保存情况
        getInsertTagInfo: url + '/oms/pushMessage/getInsertTagInfo.cf',
        ...
        */
        // SNS推广列表
        getSnsList: url + '/oms/sellerSnsPromotion/list.cf',

        // 审核
        auditSns: url + '/oms/sellerSnsPromotion/audit.cf',

        // 删除
        delSns: url + '/oms/sellerSnsPromotion/delete.cf',

        // 发布
        publishSns: url + '/oms/sellerSnsPromotion/deploy.cf',

        // SNS详情
        getSnsDetail: url + '/oms/sellerSnsPromotion/detail.cf',

        // OMS 运营人员添加sns文章
        addSnsPromotion: url + '/oms/sellerSnsPromotion/addSnsPromotion.cf',

        // SNS详情
        updateSnsPromotion: url + '/oms/sellerSnsPromotion/updateSnsPromotion.cf',

        // 文章前十个位置
        updateSnsPromotionTop10: url + '/oms/sellerSnsPromotion/updateSnsPromotionTop10.cf',

        // 文章前十个位置
        getSnsPromotionTop10s: url + '/oms/sellerSnsPromotion/getSnsPromotionTop10s.cf',
        ...
        */
        ...
        // 列表
        getProductDevList: url + '/oms/event/market/datalist.cf',

        // 审核
        auditProductDev: url + '/oms/event/market/audit.cf',

        // 详情
        getProductDevDetail: url + '/oms/event/market/detail.cf'
