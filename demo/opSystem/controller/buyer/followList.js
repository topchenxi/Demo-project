            ...
            tools = $.extend(tools, {
                ...
                saveFlatBuyerInfo: function() {
                    ...
                    var buyerInfo = {
                        ...
                        wechat: vm.buyerOfPlatInfo.personal.wechat,
                        whatsapp:vm.buyerOfPlatInfo.personal.whatsapp
                    }
                ...
                saveCfecBuyerInfo: function() {
                    ...
                    var buyerInfo = {
                        ...
                        whatsapp: vm.buyerOfCfecInfo.personal.whatsapp,
                        wechat: vm.buyerOfCfecInfo.personal.wechat
                    }
                    if (buyerInfo.companyCountryId == null) buyerInfo.companyCountryId = 0;
